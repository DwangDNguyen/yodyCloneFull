<div class="footer">
    <div class="footer-container">
        <div class="logo-footer">
            <img src="frontend/img/logo_footer.webp">
        </div>
        <div class="footer-container-col respon-tablet-1">
            ...
            <div class="footer-social">
                <a href="" class="footer-social-link">
                    <img src="frontend/img/social_1.webp">
                </a>
                <a href="" class="footer-social-link">
                    <img src="frontend/img/social_2.webp">
                </a>
                <a href="" class="footer-social-link">
                    <img src="frontend/img/social_3.webp">
                </a>
                <a href="" class="footer-social-link">
                    <img src="frontend/img/social_4.webp">
                </a>
                <a href="" class="footer-social-link">
                    <img src="frontend/img/social_5.webp">
                </a>
                <a href="" class="footer-social-link">
                    <img src="frontend/img/social_6.webp">
                </a>
                <a href="" class="footer-social-link">
                    <img src="frontend/img/social_7.webp">
                </a>
                <a href="" class="footer-social-link">
                    <img src="frontend/img/social_8.webp">
                </a>
            </div>
        </div>
        ...
        <div class="footer-container-col respon-tablet-4">
            ...
            <div class="footer-container-col-info">
                <img src="frontend/img/icon_address.webp">
                <div class="footer-container-col-info-text">
            ...
            <div class="footer-container-col-info">
                <img src="frontend/img/logo_bct.webp">
            </div>
        </div>
    </div>
    <div class="copyright">
...
<script src="<?php echo base_url('frontend/js/cart.js'); ?>"></script>
