...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('frontend/css/register.css'); ?>" />
    ...
    if ($title->main_category_id === $mainCate->main_categories_id) {
        ...
        <header class="header-menu-tablet">
            <div class="header-menu-tablet-list">
                <a href="<?php echo base_url(''); ?>" class="header-menu-tablet-items">
                    <div>
                ...
                <?php if ($this->session->userdata('LoggedIn')) {?>
                <a href="<?php echo base_url('user'); ?>" class="header-menu-tablet-items active-menu-tablet">
                    <div>
                ...
                <?php } else {?>
                <a href="<?php echo base_url('login'); ?>" class="header-menu-tablet-items active-menu-tablet">
                    <div>
                        <img src="https://bizweb.sapocdn.net/100/438/408/themes/863105/assets/nav_mb_ico_5.svg?1663769566786"
                            class="none-active">
                        <img src="https://bizweb.sapocdn.net/100/438/408/themes/863105/assets/nav_mb_ico_5_active.svg?1663771722557"
