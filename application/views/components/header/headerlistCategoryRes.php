...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('frontend/css/listCategoriesRes.css'); ?>" />
    ...
    if ($title->main_category_id === $mainCate->main_categories_id) {
        ...
        <header class="header-menu-tablet">
            <div class="header-menu-tablet-list">
                ...
                <a href="<?php echo base_url('category'); ?>" class="header-menu-tablet-items active-menu-tablet">
